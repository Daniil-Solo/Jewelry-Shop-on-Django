...
class Jewelry(models.Model):
    ...
    potpourri_cat = models.ManyToManyField(
        to="Potpourri",
        verbose_name="сухоцвет"
    )
...
class Potpourri(models.Model):
    title = models.CharField(max_length=50, verbose_name="название")
    slug = models.SlugField(unique=True, max_length=50, verbose_name="слаг")
    image = models.ImageField(upload_to='images/%Y/%m/%d/', max_length=100, verbose_name="изображения")
    description = models.TextField(null=True, blank=True, verbose_name="описание")
